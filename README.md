...
![Waferfehler](MSTIMG/waferfehler.jpg)
...
![Transistor](MSTIMG/transistor.jpg)

![Transistor](MSTIMG/transistor2.jpg)
...
![Rein-Vert](MSTIMG/reinraum-vert.jpg)
...
Wegen des geringen Drucks ist die mittlere freie Weglänge groß, weswegen die Teilchen fast
...
2. Teilchenstrahlung (Ionen oder Elektronen), aus Ionen oder Elektronenkanone
...
1. Spülen mit deionisiertem Wasser
...
2. Mit Anlegen eines äußeren Potentials: Defektelektronen ("Löcher") wandern zur Oberfläche und schwächen die H- Bindungen
...
Verhältnis zwischen Luftvolumen und Gesamtvolumen der porösen Schicht Gravimetrische Bestimmung: P = heraus geätzte Masse/Masse der porösen Schicht
14.19 Einfluss auf die Porenbildung
Wie kann die Porenbildung an der Substratoberfläche gezielt beeinflusst werden?
Anätzen des Siliziums (Ort der Porenbildung), zeitliche Variation des Stromverlaufs (Gradient bei Porendurchmesser), HF-Konzentration (Porendurchmesser)
14.20 Poröses Siliciumoxid
Wie kann poröses Siliciumoxid hergestellt werden?
poröses Si kann oxidiert werde  poröses SiO2
14.21 Absolut-Drucksensor mit porösem Silizium
Beschreiben Sie die wesentlichen Teilschritte bei der Herstellung eines Absolut-Drucksensors unter Verwendung von porösem Silizium.
1. Man beginnt Starting structure
2. Anschließend folgt Anodization mit folgenden Prozessen:
 seed layey
 cavity layer
 mask desolution
3. Epitaxy
...
1. hermetische Kapselung oft nicht möglich
2. mechanische Bestandteile oft empfindlich gegenüber Druck, Temperatur sowie Partikel
3. Thermische induzierte Spannungen (unterschiedliche Ausdehnungskoeffizienten)
15.2 Full-Wafer-Bonden
a) Erläutern Sie bitte für das Silizium-Fusion Bonding zweier Silizium-Wafer a. den Prozessablauf, b. den chemischen Hintergrund für den Bondprozess, c. die Vor- & Nachteile des Bondprozesses
a.
1. Reinigen der Wafer
2. Hydrophyilisieren der Oberfläche
3. Justage und Prebond
4. Tempern ( 1000°C, 60 min)
b.
Unter 300°C: Van-der-Waals-Bindungen
2. 300°C: Wafer wachsen zusammen: Si-OH + OH-Si  H2O + Si-O-Si
3. Über 300°C: volle Bondkraft
c.
Vorteile:
1. sehr feste Bondverbindung
2. einfache Technik
3. Geringe Kosten
Nachteile:
1. Wafer müssen glatt und planar sein
2. Sehr empfindlich gegen Staub
3. Sehr hohe Temperatur erforderlich (nur vor Metallisierungen möglich; meist also nur am Anfang einer Prozesskette einsetzbar)
4. elektrisch isolierende Verbindung (kann aber auch Vorteil sein)
b) Erläutern Sie bitte für das Anodische Bonden
a. welche Materialien verwendet werden und worauf bei der Materialauswahl zu achten ist b. den Prozessablauf sowie c. die Vor- & Nachteile des Bondprozesses
a.
Metalle/ Halbleiter werden mit ionenhaltigem Glas verbunden (Ionen müssen im Glas vorhanden sein) Pyrex-Glas (ähnlicher, thermischer Ausdehnungskoeffizient wie Silizium)
b.
1. Bei einer Temperatur oberhalb des Glasübergangspunkts wird Glas elektrisch leitend
2. Anlegen einer Spannung
3. Die elektrostatischen Kräfte der Raumladungszone im Glas und im Siliziumwafer bringen die beiden Wafer in innigen Kontakt Kovalente Bindung
c.
Vorteile:
1. mäßige Temperaturbelastung  auch nach Metallisierung anwendbar (z.B. Drucksensor)
2. gute thermische Anpassung der Materialien
3. geringe Anforderungen an Oberflächen-Qualität
Nachteile:
1. Pyrex-Glas isoliert sowohl elektrisch als auch thermisch
2. Elektrische Überschläge können insbesondere beim Bonden strukturierter Wafer auftreten und Strukturen bzw. Bauelemente zerstören
3. Pyrex ist nicht so gut zu bearbeiten wie Silizium
4. Temperaturbelastung für manche Anwendungen immer noch zu hoch
c) Erläutern Sie bitte für das eutektische Bonden eines Silizium- Chips auf einen Träger a. welche Materialien bzw. welcher Schichtaufbau verwendet wird b. den Prozessablauf sowie c. die Vor- & Nachteile des Bondprozesses
a.
Erster Wafer: Haftschicht & Diffusionssperre für Au  Schicht aus 1 – 2 μm Gold
Zweiter Wafer (oder Chip): dünne Goldschicht zur Vermeidung von Oxidbildung
b.
1. Si + leichter Druck + reibende Bewegung in Kontakt mit Au bringen und auf 390°C erhitzen
2. Au diffundiert am Interface in Si
3. Reines Si und Au schmelzen nicht, aber die Mischung 70% Gold / 30 % Si schmilzt bei 370°C  Eutektikum
4. Mischungsbereich breitet sich aus und stoppt erst, wenn ein Legierungspartner (i.d.R. Au) aufgebraucht ist
c.
Vorteile:
1. gute elekt./ therm. Leitung
2. sehr große Haftfestigkeit
Nachteile:
Große thermische Spannungen aufgrund unterschiedlicher Ausdehnungskoeffizienten
...
Minimale Chipkantenlänge: 500 μm (kleinere Chips lösen sich von der Folie)
15.4 Anisotropes Leitkleben
Erläutern Sie für das anisotrope Leitkleben
a. die Prozessführung b. die Vor- & Nachteile des Prozesses
a.
...
2. keine mech. Schwachstellen
3. Miniaturisierung
4. Geringere Verspannungen als beim Löten
Nachteile:
...
4. Kein guter Isolator trotz hohen elektrischen Widerstand
...
b. Surface Mount Devices (SMD)
Bauteile werden direkt auf die Oberfläche der Platine geklebt und anschließend durch Reflow-Löten mechanisch befestigt und elektrisch kontaktiert
Vorteil: keine Bestückungslöcher erforderlich
15.6 Drahtbonden
a) Erläutern Sie bitte für das Ball-Wedge-Bonden (Kugel- Keil-Schweißen) a. welche Materialien verwendet werden (für den Draht bzw. das Pad) b. den Prozessablauf sowie c. die Vor- & Nachteile des Bondprozesses
a.
Draht: Gold (Au), Pad: metallischer Bereich z.B. Aluminium
b.
1. Bonddraht wird in Kapillare geführt
2. Kugel am Ende des Bonddrahtes wird auf das Bondpad gedrückt und aufgeschweißt, Nailhead
3. Drahtbremse offen: Bonddraht wird abgespult
4. Kapillare bewegt sich zu Gegenkontakt und formt dabei den Loop
5. Draht wird auf Gegenkontakt abgedrückt  Wedge
6. Drahtbremse geschlossen: Abscheren/ Abreißen des Drahts
7. Drahtende wird durch elektrischen Funken/Flamme zu einer Kugel geformt
c. Vorteile:
1. Nailhead rotationssymmetrisch
2. Größere Kontaktfläche
Nachteile:
1. Nur Au
2. Bonds können nicht eng gesetzt werden
b) Erläutern Sie bitte für das Wedge-Wedge-Bonden (Keil-Keil-Schweißen) a. welche Materialien verwendet werden (für den Draht bzw. das Pad) b. den Prozessablauf sowie c. die Vor- & Nachteile des Bondprozesses
a.
Gold (Au) oder Al-Si-Legierung
b.
1. Draht, der schräg in Bondwerkzeug liegt, wird unter seiner Stirnfläche Zusammengepresst > erster Wedge entsteht
2. Drahtbremse offen: Vorfahren des Bondkopfes > Loop entsteht
3. Drahtbremse geschlossen: Bondwerkzeug presst wieder den Draht unter seiner Stirnfäche zusammen > 2. Wedge entsteht
4. Beim Entfernen des Bondwerkzeugs reißt der Draht ab
c. Vorteile:
1. kleinerer Loop
2. Bonds enger platzierbar, kleinere Bondpads
3. Al und Au können für Draht verwendet werden
Nachteile: Richtung festgelegt
